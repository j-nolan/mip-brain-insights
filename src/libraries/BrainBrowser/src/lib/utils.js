  ...
  window.BrainBrowser.utils = {
    ...
    */
    webglExtensionAvailable: function(name) {
      if (!window.BrainBrowser.WEBGL_ENABLED) {
        return false;
      }
    ...
    */
    getWorkerImportURL: function() {
      var worker_dir = window.BrainBrowser.config.get("worker_dir");
    ...
    */
    min: function() {
      ...
      array = array.length === 1 && window.BrainBrowser.utils.isNumeric(array[0].length) ? array[0] : array;
    ...
    */
    captureMouse: function(element) {
      ...
      document.addEventListener("mousemove", function(event) {
        var offset = window.BrainBrowser.utils.getOffset(element);
        var x, y;
