...
(function() {
  ...
  var loader = window.BrainBrowser.loader = {
    ...
    */
    loadColorMapFromURL: function(url, callback, options) {
      loader.loadFromURL(url, function(data, filename, options) {
        callback(window.BrainBrowser.createColorMap(data, options), filename, options);
      }, options);
    },
    ...
    */
    checkCancel: function(options) {
      options = options || {};
      if (window.BrainBrowser.utils.isFunction(options)) {
